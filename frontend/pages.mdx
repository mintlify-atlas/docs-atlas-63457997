...
|---|---|---|
| `/` | `app/page.tsx` | Root landing page. Currently renders a minimal placeholder. |
...
| `/home/post` | `app/home/post/page.tsx` | Component post detail view. Shows the post title, description, author info, publication date, tech-stack tags, star rating, action buttons (Share, Edit, Delete), a syntax-highlighted code block with a **"Descargar archivo"** button, and a fixed 300 px right-side **Comentarios** sidebar with an input field. |
